...
# ---------------------------------------------------------------------------
# OMF record evaluation / segment construction (R8: moved verbatim from
# gsasm/link.py — these are OMF-record semantics, not linking policy; link.py
# re-exports them so historical call sites keep working)
# ---------------------------------------------------------------------------
